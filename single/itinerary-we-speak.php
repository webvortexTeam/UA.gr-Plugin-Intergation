...
?>
<?php if (!empty($itinerary['spoken_languages'] )): ?>
 ...
 <div style="display: flex; align-items: center;">
    ...
    <h2 class="text-2xl text-gray-900" style="margin-right: 5px;"><?php echo $locale_activities === 'en' ? 'We' : ''; ?></h2>
    <h2 class="text-2xl text-gray-900" style="color: <?php echo $button_color;?>; margin-right: 5px;"><?php echo $locale_activities === 'en' ? 'Speak' : 'Μιλάμε'; ?></h2>
</div>
...
<ul class="what-is-included-vortex">
    <?php foreach ($itinerary['spoken_languages']  as $included): ?>
        <?php
