...
<?php if (!empty($itinerary['details']['included'])): ?>
 ...
 <div style="display: flex; align-items: center;">
    ...
    <h2 class="text-2xl text-gray-900" style="margin-right: 5px;"><?php echo $locale_activities === 'en' ? 'What is' : 'Τι'; ?></h2>
    <h2 class="text-2xl text-gray-900" style="color: <?php echo $button_color;?>; margin-right: 5px;"><?php echo $locale_activities === 'en' ? 'included' : 'περιλαμβάνεται'; ?></h2>
</div>
