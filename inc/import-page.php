        ...
        <body class="bg-gray-50 text-gray-900 font-sans">
            <div class="min-h-screen flex items-center justify-center">
                <div class="bg-white p-10 rounded-lg shadow-lg w-full max-w-md border border-red-500">
                    <h1 class="text-3xl font-bold mb-6 text-center text-red-600">Εισαγωγή δραστηριοτήτων</h1>
                    <form method="post" action="" class="flex flex-col">
                        <input type="hidden" name="unlimited_andrenaline_import_activities" value="1">
                        <button type="submit" class="py-2 px-4 bg-red-500 hover:bg-red-600 rounded-lg text-white font-semibold transition-colors duration-300">Έναρξη</button>
                    </form>
                    <?php
                    ...
                    <div id="import-progress" class="mt-6">
                        ...
                        <p class="text-lg"><strong>Imported Δραστηριότητες:</strong> <span id="activities-imported" class="text-red-500"><?php echo get_option('activities_imported', 0); ?></span></p>
                    </div>
                </div>
            </div>
        </body>
